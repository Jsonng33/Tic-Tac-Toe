...
public class TicTacToeComputer extends Application{
					...
					int row = GridPane.getRowIndex((Node)(e.getSource())).intValue();
						...
						try {
								...
								if(board[row][col] == "O" || board[row][col] == "X") {
									throw new InvalidSpot("This spot is already taken, please choose another one.");
								}
								else {
									board[row][col] = "O";
							...
							int rowNum = comNum.nextInt(3);
							int colNum = comNum.nextInt(3);
							
							while(board[rowNum][colNum] == "O" || board[rowNum][colNum] == "X") {
								rowNum = comNum.nextInt(3);
								colNum = comNum.nextInt(3);
							}
							
							board[rowNum][colNum] = "X";
								
							btn[rowNum][colNum].setText("X");
							btn[rowNum][colNum].setFont(Font.font(45));
